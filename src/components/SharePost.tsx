...
export function SharePost({ title, slug }: SharePostProps) {
  ...
  const platforms = [
    ...
    { icon: "fa-brands fa-linkedin-in", label: "LinkedIn", href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`, accent: "hover:bg-blue-600/10 hover:text-blue-700 hover:border-blue-600/30" },
